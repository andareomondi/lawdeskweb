      ...
      <main className="pt-20">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">About LawDesk</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Empowering legal professionals across Africa with modern technology
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                We believe that legal professionals deserve better tools. LawDesk was founded to solve the real problems
                lawyers face every day: managing cases, tracking deadlines, organizing documents, and staying on top of
                their practice.
              </p>
              <p className="text-muted-foreground">
                By combining modern technology with deep understanding of legal workflows, we're building the case
                management system that lawyers actually want to use.
              </p>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  title: "Simplicity",
                  description: "We believe great software should be intuitive and easy to use, not complex.",
                },
                {
                  title: "Reliability",
                  description: "Lawyers depend on us. We take security, uptime, and data protection seriously.",
                },
                {
                  title: "Accessibility",
                  description:
